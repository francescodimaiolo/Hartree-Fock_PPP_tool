...
!!!!!
  ...
  write(15,*)'certain molecular geometry as geom.xyz file.'
  write(15,*)
...
if(dabs(w(nel/2)-w(nel/2-1)).lt.1d-5)then
   write(*,*)'WARNING! HOMO and LUMO are doubly degenerate. So, HOMO-LUMO exchange integral is not well-defined!'
   write(*,*)'EXITING...'
   stop
endif
